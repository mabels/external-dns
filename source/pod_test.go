...
func TestPodSource(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			"",
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("a.foo.example.org"), Targets: endpoint.Targets{"54.10.11.1", "54.10.11.2"}, RecordType: endpoint.RecordTypeA},
				{Name: endpoint.NewEndpointNameCommon("internal.a.foo.example.org"), Targets: endpoint.Targets{"10.0.1.1", "10.0.1.2"}, RecordType: endpoint.RecordTypeA},
			},
			false,
			[]*corev1.Node{
				{
		...
		},
		{
			...
			"",
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("a.foo.example.org"), Targets: endpoint.Targets{"2001:DB8::1", "2001:DB8::2"}, RecordType: endpoint.RecordTypeAAAA},
				{Name: endpoint.NewEndpointNameCommon("internal.a.foo.example.org"), Targets: endpoint.Targets{"2001:DB8::1", "2001:DB8::2"}, RecordType: endpoint.RecordTypeAAAA},
			},
			false,
			[]*corev1.Node{
				{
		...
		},
		{
			...
			"",
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("a.foo.example.org"), Targets: endpoint.Targets{"54.10.11.1"}, RecordType: endpoint.RecordTypeA},
				{Name: endpoint.NewEndpointNameCommon("a.foo.example.org"), Targets: endpoint.Targets{"2001:DB8::1"}, RecordType: endpoint.RecordTypeAAAA},
				{Name: endpoint.NewEndpointNameCommon("b.foo.example.org"), Targets: endpoint.Targets{"54.10.11.2"}, RecordType: endpoint.RecordTypeA},
			},
			false,
			[]*corev1.Node{
				{
		...
		},
		{
			...
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("a.foo.example.org"), Targets: endpoint.Targets{"54.10.11.1"}, RecordType: endpoint.RecordTypeA},
				{Name: endpoint.NewEndpointNameCommon("internal.a.foo.example.org"), Targets: endpoint.Targets{"10.0.1.1"}, RecordType: endpoint.RecordTypeA},
			},
			false,
			[]*corev1.Node{
				{
		...
		},
		{
			...
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("internal.a.foo.example.org"), Targets: endpoint.Targets{"10.0.1.1"}, RecordType: endpoint.RecordTypeA},
				{Name: endpoint.NewEndpointNameCommon("internal.b.foo.example.org"), Targets: endpoint.Targets{"10.0.1.1"}, RecordType: endpoint.RecordTypeA},
			},
			false,
			[]*corev1.Node{
				{
