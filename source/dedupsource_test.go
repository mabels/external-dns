...
func testDedupEndpoints(t *testing.T) {
	for _, tc := range []struct {
	...
	}{
		{
			...
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
			},
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
			},
		},
		{
			...
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
				{Name: endpoint.NewEndpointNameCommon("bar.example.org"), Targets: endpoint.Targets{"4.5.6.7"}},
			},
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
				{Name: endpoint.NewEndpointNameCommon("bar.example.org"), Targets: endpoint.Targets{"4.5.6.7"}},
		...
		},
		{
			...
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"4.5.6.7"}},
			},
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"4.5.6.7"}},
		...
		},
		{
			...
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
				{Name: endpoint.NewEndpointNameCommon("bar.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
			},
			[]*endpoint.Endpoint{
				{Name: endpoint.NewEndpointNameCommon("foo.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
				{Name: endpoint.NewEndpointNameCommon("bar.example.org"), Targets: endpoint.Targets{"1.2.3.4"}},
