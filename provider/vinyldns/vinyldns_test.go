...
func testVinylDNSProviderApplyChanges(t *testing.T) {
	...
	changes.Create = []*endpoint.Endpoint{
		{Name: endpoint.NewEndpointNameCommon("example.com"), Targets: endpoint.Targets{"vinyldns.com"}, RecordType: endpoint.RecordTypeCNAME},
	}
	changes.UpdateNew = []*endpoint.Endpoint{
		{Name: endpoint.NewEndpointNameCommon("example.com"), Targets: endpoint.Targets{"vinyldns.com"}, RecordType: endpoint.RecordTypeCNAME},
	}
	changes.Delete = []*endpoint.Endpoint{{Name: endpoint.NewEndpointNameCommon("example.com"), Targets: endpoint.Targets{"vinyldns.com"}, RecordType: endpoint.RecordTypeCNAME}}
